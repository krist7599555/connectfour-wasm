...
* @returns {string}
*/
function solve15puzzle(s) {
    try {
        const retptr = wasm.__wbindgen_export_0.value - 16;
        wasm.__wbindgen_export_0.value = retptr;
        var ptr0 = passStringToWasm0(s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.solve15puzzle(retptr, ptr0, len0);
...
function wasm$1(imports){return _loadWasmModule(0, 'b0a44c6db67ec35b.wasm', null, imports)}
...
// (4:4) {#each react_list as item (item)}
function create_each_block_1(key_1, ctx) {
	...
	return {
		...
		c() {
			...
			t0 = text(t0_value);
			t1 = space();
			attr(div, "class", "item svelte-10bst2e");
			toggle_class(div, "hidden", /*item*/ ctx[14] == 0);
			this.first = div;
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*react_list*/ 2 && t0_value !== (t0_value = /*item*/ ctx[14] + "")) set_data(t0, t0_value);

			if (dirty & /*react_list*/ 2) {
				toggle_class(div, "hidden", /*item*/ ctx[14] == 0);
			}
		},
		r() {
...
// (11:4) {#each history as h}
function create_each_block(ctx) {
	let div;
	let t0_value = way2arrow(/*h*/ ctx[11].way) + "";
	let t0;
	let t1;
	let div_flag_value;
	...
	return {
		c() {
			...
			t1 = space();
			attr(div, "class", "item svelte-10bst2e");
			attr(div, "flag", div_flag_value = /*h*/ ctx[11].flag);
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t0);
		...
		p(ctx, dirty) {
			if (dirty & /*history*/ 1 && t0_value !== (t0_value = way2arrow(/*h*/ ctx[11].way) + "")) set_data(t0, t0_value);

			if (dirty & /*history*/ 1 && div_flag_value !== (div_flag_value = /*h*/ ctx[11].flag)) {
				attr(div, "flag", div_flag_value);
			}
		},
		d(detaching) {
			if (detaching) detach(div);
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let each_value_1 = /*react_list*/ ctx[1];
	...
	return {
		c() {
			div2 = element("div");
			h1 = element("h1");
			h1.textContent = "Super 15 Puzzle";
			t1 = space();
			div0 = element("div");
			...
			attr(h1, "class", "svelte-10bst2e");
			attr(div0, "class", "grid svelte-10bst2e");
			attr(div1, "class", "history svelte-10bst2e");
			attr(button0, "class", "button svelte-10bst2e");
			attr(button1, "class", "button svelte-10bst2e");
			attr(div2, "class", "puzzle svelte-10bst2e");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(window, "keydown", /*keypress*/ ctx[2]),
					listen(button0, "click", /*solve*/ ctx[3]),
		...
		p(ctx, [dirty]) {
			if (dirty & /*react_list*/ 2) {
				const each_value_1 = /*react_list*/ ctx[1];
				for (let i = 0; i < each_blocks_1.length; i += 1) each_blocks_1[i].r();
				each_blocks_1 = update_keyed_each(each_blocks_1, dirty, get_key, 1, ctx, each_value_1, each0_lookup, div0, fix_and_destroy_block, create_each_block_1, null, get_each_context_1);
				for (let i = 0; i < each_blocks_1.length; i += 1) each_blocks_1[i].a();
			}

			if (dirty & /*history, way2arrow*/ 1) {
...
function instance($$self, $$props, $$invalidate) {
	...
	function try_move_item(way, flag = 0) {
		...
		if (new_ls) {
			$$invalidate(5, ls = new_ls);
			$$invalidate(0, history = [...history, { way, flag }]);
		}
	}
	...
	function solve() {
		...
		zip(from(ans), interval(200)).pipe(map(v => v[0]), map(c => ({ "U": -4, "L": -1, "R": 1, "D": 4 })[c])).subscribe(w => try_move_item(w, 1), e => console.error(e), () => is_block_input = false);
	}

	const click_handler = () => $$invalidate(0, history = []);
	let react_list;
	let history_render;

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*ls*/ 32) {
			 $$invalidate(1, react_list = ls.split("").map(c => {
				return ({
					"A": 10,
					"B": 11,
					"C": 12,
		...
		if ($$self.$$.dirty & /*history*/ 1) {
			 history_render = history.map(w => ({ "4": "↑", "1": "←", "-1": "→", "-4": "↓" })[w.way]);
		}
	};

	return [history, react_list, keypress, solve, click_handler];
}

class App extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-10bst2e-style")) add_css();
